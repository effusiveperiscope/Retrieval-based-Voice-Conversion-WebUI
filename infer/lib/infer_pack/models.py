...
class SynthesizerTrnMsWhisperNSFsid(SynthesizerTrnMs256NSFsid):
    def __init__(
        self,
        spec_channels,
        segment_size,
        ...
        **kwargs
        ...
        super(SynthesizerTrnMsWhisperNSFsid, self).__init__(
            spec_channels,
            segment_size,
            inter_channels,
            hidden_channels,
        ...
        self.enc_p = TextEncoder(
            1280, # Whisper outputs 1280 content channels
            inter_channels,
            hidden_channels,
            filter_channels,
            n_heads,
